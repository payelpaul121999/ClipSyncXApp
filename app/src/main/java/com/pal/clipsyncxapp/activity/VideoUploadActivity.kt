...
import com.pal.clipsyncxapp.databinding.ActivityVideoUploadBinding
...
class VideoUploadActivity : AppCompatActivity() {
    ...
    private fun postToFirestore(url : String){
        ...
        Firebase.firestore.collection("videos")
            ...
            .addOnSuccessListener {
                setInProgress(false);
                allFiles.showToast(applicationContext, "Video uploaded")
                finish()
            }.addOnFailureListener {
                setInProgress(false)
                allFiles.showToast(applicationContext, "Video failed to upload")
            }
    }
