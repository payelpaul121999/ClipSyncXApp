...
import com.pal.clipsyncxapp.databinding.VideoItemRawBinding
...
class VideoListAdapter(
    ...
    inner class VideoViewHolder(private val binding : VideoItemRawBinding) : RecyclerView.ViewHolder(binding.root){
        fun bindVideo(videoModel: VideoModel){
            ...
            binding.userDetailLayout.setOnClickListener {
                Log.e("#HHHH","click ${videoModel.videoId}")
                val intent = Intent(binding.userDetailLayout.context, ProfileActivity::class.java)
                intent.putExtra("profile_user_id", videoModel.videoId )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoViewHolder {
        val binding = VideoItemRawBinding.inflate(LayoutInflater.from(parent.context),parent,false)
